  ...
  return (
    <div className="app">
      ...
      <main>
        ...
        {/* ══ PER HARI ══ */}
        {tab==="perhari" && (()=>{
          // Pakai data PENUH tanpa filter dashboard
          const phMetaByDay={};
          metaData.forEach(r=>{const d=dateOnly(r["Awal pelaporan"]);if(!d)return;if(!phMetaByDay[d])phMetaByDay[d]={spend:0,clicks:0};phMetaByDay[d].spend+=parseNum(r["Jumlah yang dibelanjakan (IDR)"]);phMetaByDay[d].clicks+=parseNum(r["Klik tautan"]);});
